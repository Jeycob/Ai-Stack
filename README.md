...
- Kontrola gateway: `curl http://127.0.0.1:9101/health` ve WSL nebo `curl http://192.168.0.48:9101/health` z LAN. Endpoint nově vrací i host-side probe `openwebui.root` a `openwebui.loader`, takže je hned vidět rozdíl mezi “gateway běží” a “OpenWebUI port 9090 je dole”.
